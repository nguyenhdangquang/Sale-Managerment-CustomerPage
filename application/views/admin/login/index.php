  ...
  <div class="login-box-body">
    ...
    <form data-toggle="validator" role="form" name="form" id="form-signUp" class="form-horizontal" enctype="multipart/form-data" method="POST" action="">
        <div class="form-group has-feedback">
          ...
          <input type="email" name="username" class="form-control input-userName test" required placeholder="Nhập tên tài khoản tại đây" />
...
<!--           <input type="password" class="form-control" placeholder="Password"> -->
          <input type="password" name="password" class="form-control input-pass test" data-minlength="6" required data-error="Mật khẩu phải ít nhất 6 kí tự" placeholder="Nhập mật khẩu tại đây">
          <div class="underline"></div>
          <div class="help-block with-errors"></div>
