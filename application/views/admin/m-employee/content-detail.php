<div class="content-wrapper" style="min-height: 916px;">
    ...
    <div class="content-main">
    	<div class="container">
    		<div class="row">
    		<?php foreach ($ListEmpDetail as $key => $value): ?>
    			<div class="col-sm-5">
    				<div class="card">
    			...
    			<div class="col-sm-6">
    				<div class="card">
					  <div class="card-body">
					    <h1 class="card-title"><?php echo $value['HoVaTen'] ?></h1>
					    ...
					    <a href="<?php echo base_url('admin/MEmployee') ?>" class="btn btn-primary">Go back</a>
					  </div>
					</div>
    			</div>
    		</div>
