<div class="content-wrapper" style="min-height: 3421px;">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">$1000000000</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">100000000</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Biểu đồ biểu diễn doanh thu 6 tháng gần nhất năm 2017</strong>
                  </p>
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Số vé xác nhận</span>
