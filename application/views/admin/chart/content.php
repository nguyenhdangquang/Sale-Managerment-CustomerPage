<div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content-header">
      <h1>
        Statistic
        <small>by Years</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Statistic</a></li>
        <li class="active">by Years</li>
      </ol>
    </section>
              ...
              <?php
                  ...
                  */
                  ...
                  <?php  
                      ...
                      foreach ($ThongKeDHbyYear as $key => $value) {
                        array_push($data,array("value"=>$value['SUM(GiaVe)'], "label" =>"Năm ".$value['YEAR(LoaiNgay)']." "));
                      }
                  /*
