		...
		<div class="row">
			...
			<div class="col-md-6">
				<section class="section sign-in inner-right-xs">
					...
					<form name="form" id="form-signUp" enctype="multipart/form-data" method="POST" action="<?php echo base_url('site/Register/register') ?>" novalidate="true" class="login-form cf-style-1">
						<div class="field-row">
			                            <label for="username">UserName</label>
			                            <input data-toggle="tooltip" data-placement="top" title="" id="username" name="username" class="form-control input-userName username" required="" placeholder="Enter UserName" data-original-title="Enter email, please!!!" type="text">
			                        </div><!-- /.field-row -->
			                        ...
			                        <div class="field-row">
			                            ...
			                            <input data-toggle="tooltip" data-placement="top" title="" id="email" name="email" class="form-control input-email email" required="" placeholder="Enter Email" data-original-title="Enter email, please!!!" type="text">
			                        </div><!-- /.field-row -->
