                        ...
                        <div class="posts sidemeta">
                                ...
                                <div class="post format-image">
                                        ...
                                        <div class="post-content">
                                                ...
                                                <h2 class="post-title">A Beautiful Day – Standard Post with Image</h2>
                                                <ul class="meta">
                                ...
                                <div class="post format-audio">
                                        ...
                                        <div class="post-content">
                                                <div class="post-media">
                                                        <iframe src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/71631296&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false" height="166"></iframe>
                                                </div>
                                                <h2 class="post-title">Listen to your Media – Standard Post with Audio</h2>
                                                <ul class="meta">
                                                        <li>Posted By : Admin</li>
                                                        <li><a href="#">OffTopic</a>, <a href="#">Announcements</a></li>
                                                        <li><a href="#">3 Comments</a></li>
                                ...
                                <div class="post format-video">
                                        ...
                                        <div class="post-content">
                                                ...
                                                <h2 class="post-title">Introduction to CSS3 – Standard Post with Video</h2>
                                                <ul class="meta">
                                                        <li>Posted By : Admin</li>
                                                        <li><a href="#">OffTopic</a>, <a href="#">Announcements</a></li>
                                                        <li><a href="#">3 Comments</a></li>
                                ...
                                <div class="post format-standard">
                                        ...
                                        <!-- /.format-wrapper -->
                                        <div class="post-content">
                                                <h2 class="post-title">Announcement – Standard Post without Image</h2>
                                                <ul class="meta">
                                                        <li>Posted By : Admin</li>
                                                        <li><a href="#">OffTopic</a>, <a href="#">Announcements</a></li>
                                                        <li><a href="#">3 Comments</a></li>
                                        ...
                                        <div class="body">
                                                <form role="search" class="search-form">
                                                        <div class="form-group">
                                                                ...
                                                                <input id="page-search" class="search-input form-control" placeholder="Enter Keywords..." type="search">
                                                        </div>
