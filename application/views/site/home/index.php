...
<body>
    <div class="wrapper">
        ...
        <!-- ========================= HEADER : END ============================= -->
        <!-- /#top-banner-and-menu -->
        <?php $this->load->view('site/top-banner'); ?>
        <!-- /#top-banner-and-menu : end -->
        <!-- ======= HOME BANNERS ============== -->
        <?php $this->load->view('site/home-banner'); ?>
        <!-- ======= HOME BANNERS : END ============== -->
        <!-- ======= TAB PRODUCTS ============== -->
        <?php $this->load->view('site/tab-products'); ?>
        <!-- ======= TAB PRODUCTS : END ============== -->
        <!-- ======= BEST SELLERS ============== -->
        <?php $this->load->view('site/best-sellers'); ?>
        <!-- ======= BEST SELLERS : END ============== -->
        <!-- ======= RECENTLY VIEWED ============== -->
        <?php $this->load->view('site/recently-viewed'); ?>
        <!-- ======= RECENTLY VIEWED : END ============== -->
        <!-- ======= TOP BRANDS ============== -->
        <?php $this->load->view('site/top-brands'); ?>
        <!-- ======= TOP BRANDS : END ============== -->
        <!-- ======= FOOTER ============== -->
